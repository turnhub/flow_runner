defmodule FlowRunner.Spec.Block do
    ...
    def evaluate_incoming(block, flow, context, container) do
        ...
        case block.type do
            "MobilePrimitives.Message" -> FlowRunner.Spec.Blocks.Message.evaluate_incoming(flow, block, context, container)
            "MobilePrimitives.SelectOneResponse" -> FlowRunner.Spec.Blocks.SelectOneResponse.evaluate_incoming(flow, block, context, container)
