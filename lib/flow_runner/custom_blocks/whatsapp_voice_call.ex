defmodule FlowRunner.CustomBlocks.WhatsAppVoiceCall do
  @moduledoc """
  ...
  The `voice_call` block compiles to this FLOIP block. The `text` config
  ...
  @block_doc type: "Io.Turn.WhatsAppVoiceCall",
             dsl_name: "voice_call()",
             description:
             ...
             example: """
             card OfferCall do
               voice_call("Tap below to call us", display_text: "Call support")
             end
  ...
  @impl true
  def validate_config!(%{"voice_call" => %{"text" => text} = voice_call}) do
    %{voice_call: %{text: text, display_text: Map.get(voice_call, "display_text")}}
  end
